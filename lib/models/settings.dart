...
class Settings {
  ...
  factory Settings.fromMap(Map<String, dynamic> map) => Settings(
      ...
      colors: map["colors"] == null ? null : ColorsElements.fromMap(map["colors"]),
...
class ColorsElements {
  ...
  factory ColorsElements.fromMap(Map<String, dynamic> map) => ColorsElements(
      primary: map["primary"],
      secondary: map["secondary"],
      body: map["body"],
  );
  
  factory ColorsElements.fromJson(String str) => ColorsElements.fromMap(json.decode(str));
  ...
  @override
  String toString() => "ColorsElements(primary: $primary, secondary: $secondary, body: $body)";
  ...
  bool operator ==(Object other) {
    ...
    return other is ColorsElements &&
