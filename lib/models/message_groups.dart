...
class MessageGroups {
  ...
  factory MessageGroups.fromMap(Map<String, dynamic> map) => MessageGroups(
      ...
      messages: map["messages"] == null ? null : List<Messages>.from(map["messages"].map((e) => Messages.fromMap(e))),
  );
  
  factory MessageGroups.fromJson(String str) => MessageGroups.fromMap(json.decode(str));
  ...
  MessageGroups copyWith({
      ...
      messagegroupCreatedAt: messagegroupCreatedAt ?? this.messagegroupCreatedAt,
  ...
  @override
  String toString() => "MessageGroups(id: $id, receiverId: $receiverId, senderId: $senderId, messagegroupCreatedAt: $messagegroupCreatedAt, count: $count, receiverName: $receiverName, senderName: $senderName, receiverImage: $receiverImage, senderImage: $senderImage, messages: $messages)";
...
class Messages {
  ...
  @override
  String toString() => "Messages(messageGroupId: $messageGroupId, message: $message, userId: $userId, messageelementtype: $messageelementtype, status: $status)";
