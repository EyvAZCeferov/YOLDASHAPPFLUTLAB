                              ...
                              children: [
                                ...
                                Row(
                                  ...
                                  children: [
                                    ...
                                    StaticText(
                                      text:
                                          "${convertfromintToTime(ride.startTime)}",
                                      weight: FontWeight.w500,
                                      size: smalltextSize,
                                      color: iconcolor,
                                      align: TextAlign.left,
                ...
                : _controller.openmodal.value == false
                    ? Stack(fit: StackFit.expand, children: [
                        Positioned.fill(
                            ...
                            child: GoogleMap(
                              padding:
                                  EdgeInsets.only(bottom: width / 2, top: 45),
                                      ...
                                      Row(
                                        ...
                                        children: [
                                          IconButtonElement(
                                            ...
                                            onPressed: () {
                                              _controller.refreshpage.value =
                                                  true;
                                              _controller.searchinglocations
                                                  .value = [];
                                              _controller.refreshpage.value =
                                                  false;
                                              _controller
                                ...
                                child: Container(
                                    ...
                                    child: Column(
                                      ...
                                      crossAxisAlignment:
                                          CrossAxisAlignment.center,
                                      children: [
                                        _controller.currentrides.value.length >
                                                    0 &&
                                                        ...
                                                        Center(
                                                          child: SizedBox(
                                                            ...
                                                            child: StaticText(
                                                              ...
                                                              size:
                                                                  normaltextSize,
                                                              text: _controller.addresscontrollers.value[
                                                                              'position_0'] !=
                                                                          null &&
                                                                      _controller
                                                                              .addresscontrollers
                                      ...
                                      children: [
                                        SizedBox(
                                          ...
                                          child: ImageClass(
                                            ...
                                            boxfit: BoxFit.contain,
                                            url:
                                                "./assets/images/searchingcar.png",
                                          ),
                                        ),
                                        Devider(size: 5),
                                        Center(
